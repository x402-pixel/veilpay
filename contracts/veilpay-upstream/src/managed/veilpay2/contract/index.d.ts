...
export type ImpureCircuits<PS> = {
  createIntent(context: __compactRuntime.CircuitContext<PS>,
               ...
               merchantCoinPk_0: Uint8Array): __compactRuntime.CircuitResults<PS, bigint>;
  pay(context: __compactRuntime.CircuitContext<PS>,
      intentId_0: bigint,
      coin_0: QualifiedShieldedCoinInfo): __compactRuntime.CircuitResults<PS, ShieldedSendResult>;
